...
namespace DataAccessLayer.Repositories
{
    public class CompanyRepository : ICompanyRepository
    {
        ...
        public async Task<bool> SaveCompany(int id, Company company)
        {
          
            await _companyDbWrapper.DeleteAsync(t => t.CompanyCode.Equals(id.ToString()));
        ...
        {       
            return await _companyDbWrapper.DeleteAsync(t => t.CompanyCode.Equals(id.ToString()));
        }
